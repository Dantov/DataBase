...
<div class="row unselectable">
	<div class="col-sm-6 pl-1 pr-0"><span class="pull-left mt-4"><?=$statsbottom?></span></div>
...
<!-- paggination -->
<div class="row unselectable">
	<div class="col-sm-6 pl-1 pr-0"><span class="pull-left pt-2"><?=$statsbottom?></span></div>
	<div class="col-sm-6 pr-1 pl-0">
		<?php
	        echo Paginator::widget([
	            'pagination' => $pagination,
