    ...
    butt3D.onclick = function() {
        ...
        $.ajax({
            ...
            success:function(resp) {
                ...
                $( registerScript(body, '/web/assets/js_lib/three.min.js') ).on('load',function()
                {
                    // let scripts = {
                    ...
                    // };
                    registerScript(body, '/web/assets/js_lib/OrbitControls.js');
                    registerScript(body, '/web/assets/js_lib/TransformControls.js');

                    $( registerScript(body, '/web/assets/js_lib/STLLoader.js') ).on('load',function()
                    {
                        registerScript(body, '/web/views/model-view/js/view3D.js?ver='+new Date().getMilliseconds());
                    });
