...
use models\{HandlerPrices,User,PaymentManager};
...
class PaymentManagerController extends UserPouchController
{
    ...
    public string $title = 'ХЮФ::Менеджмент Оплат';
    ...
    protected function payPrices( array $priceIDs, array $excludePricesList )
    {
        ...
        foreach ( $priceIDs as $key => &$pID )
        {
            ...
            if ( !$hp->checkID($pID, 'model_prices', 'id') )
        ...
        exit( json_encode($hp->payPrices( $priceIDs )) );
    }
