...
use models\{
    NomenclatureModel, GradingSystemModel, UserCodes, 
    UsersModel, User
};
use soffit\Crypt;
...
{
    protected string $view = 'nomenclature';
    protected int $tab = 1;

    public string $title ="Номенклатура::ХЮФ";
...
JS;
    ...
    {        
        ...
        $showUserID = (int)Crypt::strDecode($showUserID);
