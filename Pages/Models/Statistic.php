...
class Statistic extends General 
{
    ...
    public function __construct() {
        ...
        $this->registerTable('users_online');
    } 
    /**
     * @return array
     * @throws \Exception
    ...
    public function getUsersOnline() : array
    {
		...
		$result = $this->USERS_ONLINE->select(['*'])->exe();
	...
	public function setUserOnline()
    {
        ...
        //$uo = $this->registerTable('users_online');
        $rUo = $this->USERS_ONLINE->select(['*'])->exe();

        $v = Registry::get('validator');//->validator;
    ...
    public function getUserOSData() : string
    {
    	$countryCode = '';
    	$ua = '';
    	if (filter_has_var(INPUT_SERVER,'HTTP_GEOIP_COUNTRY_CODE'))
        	$countryCode = filter_input(INPUT_SERVER,'HTTP_GEOIP_COUNTRY_CODE');

        //$countryCode = $_SERVER['HTTP_GEOIP_COUNTRY_CODE']??"";

        if (filter_has_var(INPUT_SERVER,'HTTP_USER_AGENT'))
        	$ua = filter_input(INPUT_SERVER,'HTTP_USER_AGENT'); //$_SERVER['HTTP_USER_AGENT']
