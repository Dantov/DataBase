...
use Views\vendor\core\{
    Router, Controller, ActiveQuery, Cookies, Config, HtmlHelper, db\Database
};
...
JS;
    ...
    protected function navBarController()
    {
        ...
        $aq = new ActiveQuery('service_data');
        $collections_arr = $aq->service_data->select(['id','name'])
