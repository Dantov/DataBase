...
use Views\vendor\core\{Crypt,HtmlHelper};
            ...
            <?php elseif ( $component === 2 ):?>
                ...
                <?php if ( count($complected??[]) ):?>
                    ...
                    <?php foreach ($complected??[] as $complect): ?>
                        <a class="imgPrev" imgtoshow="<?= $complect['img_name']??'' ?>" href="<?=HtmlHelper::URL('add-edit',['id'=>$complect['pos_id'],'component'=>2 ])?>"><?=$complect['model_type']??'' ?>
                        </a>
                    <?php endforeach;?>
                    </i>)
                <?php endif; ?>
