...
use Views\vendor\core\{Files,ActiveQuery};
...
class Handler extends General
{
	...
	function __construct( int $id = 0 )
	{
        ...
        //$this->aq = new ActiveQuery(['stock','images']);
        $this->aq->registerTable(['stock','images']);
        $this->stock = $this->aq->stock;
        $this->images = $this->aq->images;
	}
