    ...
    <div class="row">
        ...
        <div class="col-xs-12 status" id="workingCenters">
            ...
            <div class="row">
                ...
                if ( (int)$_SESSION['user']['access'] > 1 ) $barubina = '';
                ?>
                ...
                <div class="col-xs-3" style="padding-right: 2px;"><?= $columns[0] ?></div>
                <div class="col-xs-3" style="padding: 0 2px 0 2px; "><?= $columns[1] ?></div>
                <div class="col-xs-3" style="padding: 0 2px 0 2px; "><?= $columns[2] ?></div>
                <div class="col-xs-3" style="padding-left: 2px;"><?= $columns[3] ?></div>
            </div>
        </div>
        <!-- END Statuses -->
    </div><!--end row-->
