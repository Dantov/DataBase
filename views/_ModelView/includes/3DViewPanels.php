<div id="info3D" class="hidden">
	"W" Двигать | "E" Поворот | "+" Увеличить размер | "-" Уменьшить размер<br />
	"Q" переключить локаль, | зажатый "Ctrl" - привязка к сетке
</div>
<div id="buttonBlock3D" class="buttonBlock3D hidden">
	<div>
		<a type="button" class="btn btn-default" id="color" title="Цвет"><span class="glyphicon glyphicon-adjust"></span></a>
