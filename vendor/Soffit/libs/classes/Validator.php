...
//            debugAjax($rules['rules'], 'validate: $rules[rules]', END_AB);
    ...
    public function searchInputTrustedChars() : array
    {
        ...
        */
        ...
        return self::$sitc = [...$restChars, ...$charASCII, ...$charsMB];
    }
    public function filterSearchInput( string $sinput ) : string
    {
        $sitc = self::searchInputTrustedChars();
